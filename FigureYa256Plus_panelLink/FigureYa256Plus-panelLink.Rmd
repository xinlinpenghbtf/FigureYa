---
title: "基因-药物-通路多层次关联分析 | Gene-Drug-Pathway Multi-level Association"
author: "Analysis"
date: "`r Sys.Date()`"
output:
  html_document:
...
# 设置 R 环境 | Set up R environment
knitr::opts_chunk$set(echo = TRUE, fig.width = 20, fig.height = 14, dpi = 300)

# 加载所需的包 | Load required packages
library(tidyverse)
library(ggplot2)
library(patchwork)
library(scales)
...
```{r combine_panels, fig.width=20, fig.height=14}
